...
class CaesarCipher:
    '''
    The class definition that does everything related to the cipher. Encrypts, decrypts, writes and exports the message.
    '''
...
def main():
    ...
    cipher_text0 = cipher1.encrypt()
    cipher0.export_file(cipher_text0, "cipher_to_friend_1.txt")
    ...
    cipher_text0 = cipher2.encrypt()
    cipher0.export_file(cipher_text0, "cipher_to_friend_2.txt")
    ...
    cipher3.export_file(cipher_text3, "message_from_friend3.txt")
